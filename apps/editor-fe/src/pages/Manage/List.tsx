...
import { getWorksListService, type WorksList } from '@/services/works';
...
const List: FC = () => {
	...
	const [list, setList] = useState<WorksList['list']>([]); // 全部的列表数据，上划加载更多，累计
	...
	const { run: load, loading } = useRequest(
		async () => {
			const data = await getWorksListService({
				page,
